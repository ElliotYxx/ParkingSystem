...
class PlateRecognition:
    ...
    def __start_recognize__(self, src):
        ...
        if os.path.exists("/Users/sheva/IdeaProjects/ParkingSystem/parking-admin/src/main/resources/py/svm.dat"):
            self.model.load("/Users/sheva/IdeaProjects/ParkingSystem/parking-admin/src/main/resources/py/svm.dat")
        else:
        ...
        if os.path.exists("/Users/sheva/IdeaProjects/ParkingSystem/parking-admin/src/main/resources/py/svmchinese.dat"):
            self.cn_model.load("/Users/sheva/IdeaProjects/ParkingSystem/parking-admin/src/main/resources/py/svmchinese.dat")
        else:
...
if __name__ == '__main__':
    c = PlateRecognition()
    result = c.__start_recognize__("/Users/sheva/PycharmProjects/LPR/Test/0.jpg")
    # print(result)